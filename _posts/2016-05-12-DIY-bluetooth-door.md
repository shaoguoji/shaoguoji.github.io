...
![设备管理器]({{site.baseurl}}/img/bluedoor/设备管理器.png)
...
![烧写程序]({{site.baseurl}}/img/bluedoor/烧写程序.jpg)
...
![洞洞板布线图]({{site.baseurl}}/img/bluedoor/洞洞板布线图.jpg)
...
![舵机位置示意图]({{site.baseurl}}/img/bluedoor/舵机位置示意图.jpg)

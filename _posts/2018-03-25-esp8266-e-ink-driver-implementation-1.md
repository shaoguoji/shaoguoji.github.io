...
![图1 屏幕刷新效果](https://raw.githubusercontent.com/shaoguoji/blogpic/master/post-img/18249554.jpg)
...
![图3 数据显示原理图](https://raw.githubusercontent.com/shaoguoji/blogpic/master/post-img/59920391.jpg)
...
需要特别注意 Makefile 文件的一些关键参数，总 `Makefile` 文件中的 24 行通过 `SUBDIRS` 变量引入子目录:
